...
<br><p style="font-size: 0.8em;">💻 Experiência em projeto acadêmico colaborativo (Git/GitHub – repositório privado). Desenvolvi as páginas <b>Homepage</b> e <b>Gestão de Candidaturas</b>, além de participar de todas as etapas do projeto: documentação e estudo do contexto, uso da metodologia Scrum, projeto de interface e testes das funcionalidades do sistema.</p>
